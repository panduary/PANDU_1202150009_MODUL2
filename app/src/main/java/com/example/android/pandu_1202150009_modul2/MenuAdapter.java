package com.example.android.pandu_1202150009_modul2;
        ...
        public MenuViewHolder(final View itemView, MenuAdapter adapter) {
            ...
            photoItemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(itemView.getContext(), com.example.android.pandu_1202150009_modul2.DetailMenu.class);
